...
public class CustomerController {
	...
	public void customerAddCustomer(ActionEvent event) throws SQLException {
		...
		String sql = "INSERT INTO customer (customerCustomerName, customerMobileNumber, customerAdderss, customerGstinNumber) VALUES (\'"+ mCustomerName + "','" + mCustomerNumber + "','" + mCustomerAddress + "','" + mCustomerGstin + "\')";
		Statement stmt = conn.createStatement();
