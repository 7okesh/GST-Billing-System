...
// inner class for entering data into the table from observAbleList
	...
	//table view for displaying data into table
	@FXML
	...
	//all the columns of the table are intialized here
	...
	public void dealerAddDealer(ActionEvent event) throws SQLException {
		...
		String sql = "INSERT INTO dealer (dealer_company_name,dealer_company_addr,dealer_company_gstn,dealer_company_contact) VALUES (\'"+ mDealerCustomerName + "','" + mDealerAdderss + "','" + mDealerGSTINNumner + "','" + mDealerContact +"\')";
		Statement stmt = conn.createStatement();
